...
/**
 * Contains settings from properties, the detected OS, and the locations of various important files/directories.
 */
public class InstallerConfig {
  ...
  /**
   * The current OS, set in the static initializer block via System.getProperty("os.name")
   */
  public static final OS currentOS;
  
  /**
   * The target minecraft installation.
   * Defaults to the main minecraft folder, but can be set by the user in the GUI.
   */
  ...
  /**
   * The current version of minecraft, specified in config/installer.properties
   * @return
   */
  ...
  /**
   * The md5 hash (as a hex string) of the current unmodded minecraft.jar, specified in config/installer.properties
   * @return
   */
  ...
  /**
   * The desired title of the installer. Defaults to "Minecraft Modpack Installer".
   * @return
   */
  ...
  /**
   * The target minecraft folder to install to. Platform specific, but can be changed by the user.
   * @return
   */
